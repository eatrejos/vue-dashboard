<template>
    <div class="sticky top-0 z-40 bg-white">
            <div class="w-full h-20 px-6 shadow-sm border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="serch" placeholder="Search" class="bg-transparent h-10 w-full xl:w-90 px-12 rounded-lg text-sm focus:outline-none">
              ...
              <div class="flex items-center relative">
                <svg xmlns="http://www.w3.org/2000/svg" height="28" viewBox="0 0 24 24" width="28" class="fill-current text-gray-500 mr-3 hover:text-blue-500"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z"/></svg>
                <img src="https://a7sas.net/wp-content/uploads/2019/07/4060.jpeg" class="w-10 h-10 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>
